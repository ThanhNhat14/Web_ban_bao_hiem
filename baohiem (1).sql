...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 02, 2023 lúc 04:15 PM
...
(11, 'Bảo hiểm nhà', '123456', '1685714894_bao_hiem_nha2.jpg', 'Bảo hiểm nhà nè nhe', 12, 0, 5, 2);
...
INSERT INTO `hopdong` (`id_hopdong`, `id_user`, `id_baohiem`, `ten_baohiem`, `ten_khachhang`, `gioitinh`, `ngaysinh`, `cccd`, `nghenghiep`, `sodienthoai`, `diachi`, `ngayky_hopdong`, `thoihan_baohiem`, `handongtien`, `trangthai`, `tien_baohiem`) VALUES
(132, 11, 11, 'Bảo hiểm nhà', 'Nhật Thanh', 'Nam', '2003-09-21', '023456987852', 'Sinh Viên', '0785623624', 'Tân Châu', '2023-06-02 14:14:08', 5, '2023-12-02', '0', 123456),
(133, 11, 8, 'Bảo hiểm nhân thọ', 'Hồ Dung', 'Nữ', '2001-12-12', '012362325362', 'Sinh Viên', '0706830511', 'Dĩ An', '2023-06-02 14:14:08', 10, '2024-06-02', '0', 200000000),
(134, 11, 9, 'Bảo hiểm xe máy dưới 175cc', 'Lăng nè', 'Nam', '2003-12-09', '012012553256', 'Bươn chải', '0236353263', 'AN Giang', '2023-06-02 14:14:08', 1, '2023-12-02', '0', 90000),
(135, 11, 11, 'Bảo hiểm nhà', 'Mỹ Tiên', 'Nữ', '2005-11-11', '053026321542', 'Ngành', '0956223654', 'Cà mau', '2023-06-02 14:14:08', 5, '2023-12-02', '0', 123456),
(136, 11, 8, 'Bảo hiểm nhân thọ', 'Kha KHa', 'Nữ', '2001-12-25', '012012012012', 'Buôn bán', '0325263253', 'Bình Định', '2023-06-02 14:14:08', 10, '2024-06-02', '0', 200000000);
...
(211, 11, 11, 436, 'Bảo hiểm nhà', 'Nhật Thanh', '023456987852', '2003-09-21', '0785623624', 'Nam', 'Tân Châu', 5, 123456),
(212, 11, 8, 437, 'Bảo hiểm nhân thọ', 'Hồ Dung', '012362325362', '2001-12-12', '0706830511', 'Nữ', 'Dĩ An', 10, 200000000),
(213, 11, 9, 438, 'Bảo hiểm xe máy dưới 175cc', 'Lăng nè', '012012553256', '2003-12-09', '0236353263', 'Nam', 'AN Giang', 1, 90000),
(214, 11, 11, 436, 'Bảo hiểm nhà', 'Mỹ Tiên', '053026321542', '2005-11-11', '0956223654', 'Nữ', 'Cà mau', 5, 123456),
(215, 11, 8, 437, 'Bảo hiểm nhân thọ', 'Kha KHa', '012012012012', '2001-12-25', '0325263253', 'Nữ', 'Bình Định', 10, 200000000);
...
--
ALTER TABLE `chinhsach`
  MODIFY `id_baohiem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `hopdong`
  MODIFY `id_hopdong` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT cho bảng `tb_cart`
--
ALTER TABLE `tb_cart`
  MODIFY `id_cart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=343;

--
-- AUTO_INCREMENT cho bảng `tb_cart_detail`
--
ALTER TABLE `tb_cart_detail`
  MODIFY `id_cart_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=439;
...
--
ALTER TABLE `xacnhan_thanhtoan`
  MODIFY `id_thanhtoan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
COMMIT;
